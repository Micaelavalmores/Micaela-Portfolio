    ...
    <main className={styles.page}>
      ...
      <div className={styles['Plat-sec']}>
        ...
        <div className={styles['Plat-logos']}>
          <Image src="/logos/figma-logo.svg" alt="Figma Logo" width={80} height={80} />
          <Image src="/logos/sketch-logo.svg" alt="Sketch Logo" width={80} height={80} />
          <Image src="/logos/xd-logo.svg" alt="Adobe XD Logo" width={80} height={80} />
          <Image src="/logos/zeplin-logo.svg" alt="Zeplin Logo" width={80} height={80} />
          <Image src="/logos/html-logo.svg" alt="HTML5 Logo" width={80} height={80} />
          <Image src="/logos/css-logo.svg" alt="CSS3 Logo" width={80} height={80} />
          <Image src="/logos/js-logo.svg" alt="JavaScript Logo" width={80} height={80} />
          <Image src="/logos/react-logo.svg" alt="React Logo" width={80} height={80} />
        </div>
      </div>
    </main>
  )
